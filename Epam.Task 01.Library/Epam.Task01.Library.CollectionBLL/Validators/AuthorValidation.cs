...
namespace CollectionValidation
{
    public class AuthorValidation : IAuthorValidation
    {
        ...
        public IAuthorValidation CheckAuthorsFirstName(Book withAuthor)
        {
            bool notvalid = false;
            string namePattern = @"^(([A-Z][a-z]+|[А-Я][а-я]+)|([A-Z][a-z]+-[A-Z][a-z]+|[А-Я][а-я]+-[А-Я][а-я]+))$";
            foreach (Author item in withAuthor.Authors)
            {
        ...
        public IAuthorValidation CheckAuthorsFirstName(AbstractLibraryItem withAuthor)
        {
            throw new System.NotImplementedException();
        }

        public IAuthorValidation CheckAuthorsLastName(Book withAuthor)
        {
            bool notvalid = false;
        ...
        public IAuthorValidation CheckAuthorsLastName(AbstractLibraryItem withAuthor)
        {
            throw new System.NotImplementedException();
        }
    }
