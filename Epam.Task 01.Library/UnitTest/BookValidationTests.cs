...
//            string city = "Саратов";
//            int expectedValidationResuilCount = _bookValidation.ValidationObject.ValidationExceptions.Count; // и сколько ты ожидаешь получить?
...
//            string city = "Saratov";
//            int expectedValidationResuilCount = _bookValidation.ValidationObject.ValidationExceptions.Count;
...
//            string city = "city";
//            int expectedValidationResuilCount = _bookValidation.ValidationObject.ValidationExceptions.Count + 1;
...
//            int currentValidationResultCount = _bookValidation.ValidationObject.ValidationExceptions.Count;
...
//            _commonValidationMock.Setup(s => s.ValidationObject.ValidationExceptions).Returns(_bookValidation.ValidationObject.ValidationExceptions);
