...
namespace UnitTest
{
    ...
    {
        private AbstractValidation.IIssueValidation _newspaperValidation;
        private Issue _defaultNewspaperItem;
        private Mock<ICommonValidation> _commonValidationMock;
        private Mock<Epam.Task_01.Library.AbstactBLL.IValidators.INewspaperValidation> _issueValidationMock;

        [TestInitialize]
        public void Initialize()
        {
            _commonValidationMock = new Mock<ICommonValidation>();
            _issueValidationMock = new Mock<Epam.Task_01.Library.AbstactBLL.IValidators.INewspaperValidation>();
            _newspaperValidation = new IssueValidation(_commonValidationMock.Object, _issueValidationMock.Object);
        ...
        public void CheckByIssueValidation_ValidData_ReturnTrue()
        {
            ...
            int expectedValidationResuilCount = _newspaperValidation.ValidationObject.ValidationExceptions.Count;
            _issueValidationMock.Setup(s => s.ValidationObject.IsValid).Returns(true);
        ...
        public void CheckByIssueValidation_NotValidData_ReturnFalse()
        {
            ...
            _issueValidationMock.Setup(s => s.ValidationObject.IsValid).Returns(false);
            _issueValidationMock.Setup(s => s.ValidationObject.ValidationExceptions).Returns(_newspaperValidation.ValidationObject.ValidationExceptions);
            _issueValidationMock.Setup(s => s.CheckTitle(_defaultNewspaperItem.Newspaper)).Returns(_issueValidationMock.Object);
            _issueValidationMock.Setup(s => s.CheckISSN(_defaultNewspaperItem.Newspaper)).Returns(_issueValidationMock.Object);
            _issueValidationMock.Setup(s => s.CheckNewspaperCity(_defaultNewspaperItem.Newspaper)).Returns(_issueValidationMock.Object);
