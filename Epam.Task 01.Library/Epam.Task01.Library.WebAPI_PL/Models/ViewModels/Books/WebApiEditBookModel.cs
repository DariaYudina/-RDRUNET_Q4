...
namespace Epam.Task01.Library.WebAPI_PL.Models.ViewModels.Books
{
    public class WebApiEditBookModel
    {
        [Remote(
           "IsUniqueBookEdit",
           "Book",
           AdditionalFields = "YearOfPublishing, Isbn, AuthorsId, Id",
        ...
        [StringLength(19, MinimumLength = 1, ErrorMessage = "The length of the string should be from 1 to 15 characters")]
